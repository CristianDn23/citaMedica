                ...
                <form action="{{ url('/reservarcitas') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio mt-3 mb-3">
                            ...
                            @if(old('type') == 'Consulta rápida') checked @endif value="Consulta rápida">
                            <label class="custom-control-label" for="type1">Consulta rápida</label>
                        </div>
                        <div class="custom-control custom-radio mb-3">
                            <input name="type" class="custom-control-input" id="type2" type="radio" 
                            @if(old('type') == 'Consulta personalizada') checked @endif value="Consulta personalizada">
                            <label class="custom-control-label" for="type2">Consulta personalizada</label>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        rows="5" placeholder="Descripción breve de sus síntomas...." require ></textarea>
                    </div>
