      ...
      <div class="container">
        <div class="col-md-12">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="VAnsiedad.php"><img src="img/logoinit.png" class="img-responsive" style="width: 100%; margin-top: -25px;"> </a>
          </div>
          <div class="collapse navbar-collapse navbar-right" id="myNavbar">
            <ul class="nav navbar-nav">
              <li class="active"><a href="#banner">INICIO</a></li>
              <li class=""><a href="#galeria">CONSEJOS</a></li>
              <li class=""><a href="#footer">NOSOTROS</a></li>
              <li class=""><a href="../hospital/index.html">INGRESAR</a></li>
...
<div class="row d-flex justify-content-center flex-wrap">
  ...
  <div class="col-4 col-sm-4 col-md-4 col-lg-4 co-xl-3  text-center">
         <a  href="../VDepresion/VDepresion.php"><img  src="img/2icon.png"></a>
         <p class="text-dark">Consejos Antidepresivos</p>
  </div><div class="col-4 col-sm-4 col-md-4 col-lg-4 co-xl-3 text-center">
         <a  href="#"><img  src="img/1icon.png"></a>
         <p class="text-dark">Consejos Antiestres</p>
  </div><div class="col-4 col-sm-4 col-md-4 col-lg-4 co-xl-3  text-center">
         <a  href="../VAnsiedad/VAnsiedad.php"><img  src="img/3icon.png"></a>
...
<!--teampsi-->
<h1>Galeria de Consejos</h1>
 <span class="linea" id="galeria"></span>
...
<!--a--
<section class="light-box" id="image1">
  <a href="" class="next"></a>
  <img src="dos.jpg" alt="">
  <a href="" class="next"></a>
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-sm-4 marb20">
          ...
          <div class="info-sec">
            <ul class="quick-info">
              <li class="active"><a href="#banner">INICIO</a></li>
              <li class=""><a href="#teampsi">CONSEJOS</a></li>
              <li class=""><a href="#footer">NOSOTROS</a></li>
            </ul>
          </div>
        </div>
